function BM = EnKFfun_v3(mu,Afac,Bfac,nens,deltaobs)
%ENKFFUN_V1 Summary of this function goes here
%   Detailed explanation goes here

% This uses a different scheme, where nens is changed for the models
% Inspired by Baek 2006
% nens_perfect = nens;
% nens_bias1,2 = 2*nens;
% nens_bias3   = 3*nens;
% Meaningful? Still need to answer this question.

% BM: key parameters, 
%     analysis rms error, 
%     forecast rms error,
%     time averaged zeta and xi

%% Parameters allowed for change

fprintf('Start: mu=%f, Afac=%f, Bfac=%f, nens=%d, deltaobs=%f\n',...
    mu,Afac,Bfac,nens,deltaobs);
...
% Set the random seed
% TODO: make the random seed a function parameter
rng(1);
...
%%
% This section calculates the time averaged bias parameters
% And the variance over time of the parameters
% bias model 1,3 estimates zeta
% bias model 2,3 estimates xi
...
fprintf('End: mu=%f, Afac=%f, Bfac=%f, nens=%d, deltaobs=%f\n',...
    mu,Afac,Bfac,nens,deltaobs);
